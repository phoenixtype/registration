...
import dev.registrationapp.email.EmailSender;
import dev.registrationapp.enums.Role;
...
import dev.registrationapp.email.EmailValidator;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest registrationRequest) {
        ...
        if (!isValidEmail) {
            throw new IllegalStateException("email not valid" + registrationRequest.getEmail());
        }
        ...
        return "user with token " + token + " has been successfully registered";
    }
